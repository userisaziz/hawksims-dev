...
import SectionedVideoBackground from "../heroVideo";
...
const IndustriesHeroSection = () => {
  ...
  return (
    <div id="heroSection">
      {/* this below code is used for hero section conetnt and their shimmer shine effect */}
      <div className="bg-[#030515]">
        <div
          className={`relative  pt-[144px] px-[112px] border-3 border-slate-300 bg-[#030515] tablet:px-[42px] tablet:pt-[124px] 
  mobile:!pt-[120px] mobile:!px-[16px]
  `}
        >
          <div className="absolute  mobile:w-[75px] tablet:w-[150px]  w-[314.841px] h-[300px] rotate-[-22deg] left-[40%] top-[40px] rounded-[100px] opacity-15 bg-gradient-to-r from-[#5F80F6] to-[#3F49A7] filter blur-[85px] "></div>
          <div
            className={` 2xl:max-w-7xl mx-auto  text-center flex items-center  flex-col`}
          >
            <div className="flex justify-center items-center flex-col mobile:!w-[328px]">
              <h1
                className={`text-center lg:w-[768px] shine  flex flex-wrap  lg:text-[64px] font-semibold lg:leading-[83.2px] md:text-[44px] md:leading-[61.6px]
          text-[32px] leading-[44.8px]
          `}
              >
                Industries We Serve
              </h1>
              {/* <p
                className={`desktop:w-[603px] shine text-[#DFDFE0] flex flex-wrap    mt-5 
      tablet:w-[468px]
     mobile:!mt-12px text-xs px-4 md:text-sm lg:text-xl
     mobile:!w-[328px] mobile:!px-[26px]
     text-center font-inter  font-normal `}
              >
                With our focus on human-centered advanced solutions, we are the
                top choice for leading global pharmaceutical businesses seeking
                next-generation capabilities in life sciences and healthcare
              </p> */}
            </div>
          </div>
        </div>
        <div className="h-full bg-[#030515]   pb-9 md:pb-17 lg:pb-0  lg:px-[112px] pt-14 overflow-hidden px-0  w-full lg:pt-[56px] md:px-[42px] md:pt-[28px]">
          {/* <SectionedVideoBackground /> */}
          <motion.div
